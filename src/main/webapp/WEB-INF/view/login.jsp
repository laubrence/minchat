	...
	<div class="inside">
	  <table width="1000" border="0" cellpadding="0" cellspacing="0">
	    <tr>
	      ...
	      <td width="524"><div class="insidehome">
	        <div class="logo1"><img src="${ctx}/images/login/logo.png" alt="" width="163" height="40"></div>
	        ...
	        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="from">
              <tr>
                ...
                <tr>
	              <td height="34">
                 	 验证码<input name="verifyCode" type="text" style="width:100px;"></td>
	              <td colspan="2"> <img id="verifyCodeImage" onclick="reloadVerifyCode()" src="${ctx}/getVerifyCodeImage"/></td>
...
记住账号	              </span></td>
	              <td width="150" height="34" align="left"><input name="重置" type="submit" class="pushCopy" id="重置" value="重置"></td>
