...
CREATE TABLE `ct_user_msg` (
  ...
  `SEND_TYPE` int(5) DEFAULT '0' COMMENT '发送类型',
  `SEND_USER` varchar(200) DEFAULT '' COMMENT '后台客服用户id',
  `RECEIVE_USER` varchar(200) DEFAULT '' COMMENT '用户姓名',
...
-- ----------------------------
INSERT INTO `sys_db_id` VALUES ('1', '10000', '40000');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', 'admin', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', '0', '0', '2016-04-07 15:19:58', '0', null, null, null, null, 'http://p1.qzone.la/upload/20150102/a3zs6l69.jpg', '客服小二');
